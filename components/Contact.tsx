...
// Sign up free at formspree.io, create a form, and drop its ID here.
// Every valid submission below gets emailed to the address on that
// Formspree account — no server code or API key needed on your side.
const FORMSPREE_ID = "xeaqnvbz";
        ...
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1fr]">
          ...
          <form onSubmit={handleSubmit} noValidate className="max-w-prose space-y-6">
            ...
            <button
              ...
              className="rounded-full bg-amber px-6 py-3 text-sm font-medium text-ink transition-transform hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0"
            >
